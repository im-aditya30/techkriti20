...
class EnquiryHome extends StatefulWidget {
  @override
  _EnquiryHomeState createState() => _EnquiryHomeState();
}
            ...
            new SliverPadding(
              ...
              sliver: new SliverList(
                delegate: new SliverChildBuilderDelegate(
                    (context, index) => new EnquiryHospiRow(hospis[0]['members'][index]),
                  childCount: hospis[0]['members'].length,
                ),
              ),
            ),
          ],
