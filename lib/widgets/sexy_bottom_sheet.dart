...
import 'package:techkriti20/pages/event_list/dialog.dart';
...
class SexyBottomSheet extends StatefulWidget {
  ...
  final double bottom;
  final String tag;
  SexyBottomSheet({this.items, this.bottom, this.top, this.tag});
  @override
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          child: Stack(
                            // alignment: Alignment.center,
                            children: <Widget>[
                              // Hero(tag: 'hello', child: SexyTile()),
                              for (SheetItem item in widget.items)
                                buildFullItem(item),
                              for (SheetItem item in widget.items)
                                buildIcon(item),
                            ],
...
class SheetItem {
  ...
  SheetItem(this.assetName, this.title, this.screen, this.item);
}
